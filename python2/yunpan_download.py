...
class Downloader:
    def __init__(self, remote_path, session):
    ...
    def download_to(self, target_path, overwirte):
        ...
        if os.path.exists(temp_file_path):
            ...
            if os.path.exists(download_info.info_path):
                ...
                download_info.set_info(self.etag, set([i for i in range(int(self.block_number))]),
...
class DownloadInfo:
    def __init__(self, target_path, md5):
    ...
    def set_info(self, etag, to_download_blocks, block_size):
        self.etag = etag
